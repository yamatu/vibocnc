...
const DICT: Record<AdminLocale, Record<string, string>> = {
  en: {
    ...
    'sitemap.urls.subtitle': 'Use sitemap.xml as the only submission URL; child sitemaps are discovered automatically.',
    'sitemap.view': 'View',
    'sitemap.copy': 'Copy URL',
    'sitemap.instructions.title': 'SEO Instructions',
    'sitemap.instructions.1': 'Submit sitemap.xml to Google Search Console and Bing Webmaster Tools',
  ...
  zh: {
    ...
    'sitemap.urls.subtitle': '请只提交 sitemap.xml；子 sitemap 会被主索引自动发现。',
    'sitemap.view': '查看',
    'sitemap.copy': '复制链接',
    'sitemap.instructions.title': 'SEO 提示',
    'sitemap.instructions.1': '把 sitemap.xml 提交到 Google Search Console 和 Bing Webmaster Tools',
