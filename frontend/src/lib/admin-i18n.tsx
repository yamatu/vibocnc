...
const DICT: Record<AdminLocale, Record<string, string>> = {
  en: {
    ...
    'news.total': '{count} articles total',
    'news.create': 'New Article',
    'news.new': 'New Article',
    'news.edit': 'Edit Article',
    'news.deleted': 'Article deleted',
    'news.deleteFailed': 'Failed to delete article',
    'news.deleteConfirm': 'Delete "{title}"? This action cannot be undone.',
    'news.searchPlaceholder': 'Search articles...',
    'news.type.all': 'All Types',
    'news.type.label': 'Content Type',
    'news.type.news': 'News',
    'news.type.blog': 'Blog',
    'news.allStatus': 'All Statuses',
    'news.published': 'Published',
    'news.draft': 'Draft',
    'news.featured': 'Featured',
    'news.empty': 'No articles found',
    'news.col.title': 'Title',
    'news.col.slug': 'Public URL',
    'news.col.status': 'Status',
    'news.col.author': 'Author',
    'news.col.views': 'Views',
    'news.col.date': 'Date',
    'news.col.actions': 'Actions',
    'news.pagination': 'Page {page} of {pages} ({total} total)',
    'news.previous': 'Previous',
    'news.next': 'Next',
    'news.view': 'View',
    'news.notFound': 'Article not found',
    'news.toast.created': 'Article created successfully!',
    'news.toast.updated': 'Article updated successfully!',
    'news.toast.createFailed': 'Failed to create article',
    'news.toast.updateFailed': 'Failed to update article',
    'news.field.title': 'Title',
    'news.field.titleRequired': 'Title is required',
    'news.field.titlePlaceholder': 'Article title...',
    'news.field.slug': 'Custom URL Slug',
    'news.field.slugPlaceholder': 'auto-generated-from-title',
    'news.field.slugHint': 'Leave empty to generate it automatically from the title.',
    'news.field.summary': 'Summary',
    'news.field.summaryPlaceholder': 'Brief summary shown in article lists...',
    'news.field.content': 'Content',
    'news.field.contentRequired': 'Content is required',
    'news.field.contentPlaceholder': 'Write your article in Markdown...',
    'news.field.contentHint': 'External link: [label](https://example.com). For video, paste a YouTube/Vimeo URL on its own line or use @[video](URL).',
    'news.field.sortOrder': 'Sort Order',
    'news.field.featuredImage': 'Featured Image',
    'news.field.imageUrlPlaceholder': 'Or paste an image URL...',
    'news.insertImage': 'Insert Image',
    'news.selectImage': 'Select from Media',
    'news.selectFeaturedImage': 'Select Featured Image',
    'news.insertImages': 'Insert Image(s)',
    'news.editMode': 'Edit',
    'news.preview': 'Preview',
    'news.seo': 'SEO Settings',
    'news.seo.metaTitle': 'Meta Title',
    'news.seo.metaDescription': 'Meta Description',
    'news.seo.metaKeywords': 'Meta Keywords',
    'news.seo.titlePlaceholder': 'SEO title (recommended 50-60 characters)',
    'news.seo.descriptionPlaceholder': 'SEO description (recommended 150-160 characters)',
    'news.seo.keywordsPlaceholder': 'keyword1, keyword2, keyword3',
    'news.seo.googlePreview': 'Google Preview',
    'news.seo.articleTitle': 'Article Title',
    'news.seo.articleDescription': 'Article description will appear here...',
    'news.seo.titleLength': 'Title length (50-60 recommended)',
    'news.seo.descriptionLength': 'Description length (150-160 recommended)',
    'news.seo.characters': '{count} characters',
    'news.publish': 'Publish Settings',
    'news.publishedAt': 'Published: {date}',
    'news.views': 'Views: {count}',

    'sitePages.title': 'Site Pages',
    'sitePages.subtitle': 'Edit policy and informational pages linked from the website footer.',
    'sitePages.saved': 'Page saved',
    'sitePages.saveFailed': 'Failed to save page',
    'sitePages.pageTitle': 'Page title',
    'sitePages.metaTitle': 'Meta title',
    'sitePages.summary': 'Summary',
    'sitePages.metaDescription': 'Meta description',
    'sitePages.metaKeywords': 'Meta keywords',
    'sitePages.content': 'Content (Markdown)',
    'sitePages.markdownHint': 'Use ## for section headings, - for lists, [label](URL) for links, and put YouTube/Vimeo URLs on their own line.',
    'sitePages.published': 'Published',
    'sitePages.viewPage': 'View page',
    'sitePages.savePage': 'Save page',
    'sitePages.page.privacy': 'Privacy Policy',
    'sitePages.page.terms': 'Terms of Service',
    'sitePages.page.warranty': 'Warranty',
    'sitePages.page.warranty-policy': 'Warranty Policy',
    'sitePages.page.shipping-policy': 'Shipping Policy',
    'sitePages.page.returns': 'Returns Policy',
    'sitePages.page.technical-support': 'Technical Support',
  ...
  zh: {
    ...
    'nav.cache': '缓存设置',
    'nav.paypal': 'PayPal',
    'nav.socialLinks': '社交媒体与 SEO',
    'nav.indexnow': 'IndexNow / Bing',
    'nav.homepage': '首页内容',
    'nav.socialMedia': '社媒设置',
    'nav.news': '新闻与博客',
    'nav.sitePages': '站点页面',
    ...
    'news.total': '共 {count} 篇文章',
    'news.create': '新建文章',
    'news.new': '新建文章',
    'news.edit': '编辑文章',
    'news.deleted': '文章已删除',
    'news.deleteFailed': '删除文章失败',
    'news.deleteConfirm': '确定删除“{title}”吗？此操作不可撤销。',
    'news.searchPlaceholder': '搜索文章...',
    'news.type.all': '全部类型',
    'news.type.label': '内容类型',
    'news.type.news': '新闻',
    'news.type.blog': '博客',
    'news.allStatus': '全部状态',
    'news.published': '已发布',
    ...
    'news.col.date': '日期',
    'news.col.actions': '操作',
    'news.pagination': '第 {page} 页 / 共 {pages} 页（共 {total} 篇）',
    'news.previous': '上一页',
    'news.next': '下一页',
    'news.view': '查看',
    'news.notFound': '未找到文章',
    'news.toast.created': '文章创建成功！',
    'news.toast.updated': '文章更新成功！',
    'news.toast.createFailed': '创建文章失败',
    'news.toast.updateFailed': '更新文章失败',
    'news.field.title': '标题',
    'news.field.titleRequired': '请输入标题',
    'news.field.titlePlaceholder': '请输入文章标题...',
    'news.field.slug': '自定义 URL 路径',
    'news.field.slugPlaceholder': '根据标题自动生成',
    'news.field.slugHint': '留空时会根据标题自动生成。',
    'news.field.summary': '摘要',
    'news.field.summaryPlaceholder': '显示在文章列表中的简短摘要...',
    'news.field.content': '正文',
    'news.field.contentRequired': '请输入正文内容',
    'news.field.contentPlaceholder': '使用 Markdown 编写文章正文...',
    'news.field.contentHint': '外部链接：[文字](https://example.com)。视频可将 YouTube/Vimeo 链接单独放一行，或使用 @[video](URL)。',
    'news.field.sortOrder': '排序',
    'news.field.featuredImage': '特色图片',
    'news.field.imageUrlPlaceholder': '或粘贴图片链接...',
    'news.insertImage': '插入图片',
    'news.selectImage': '从图库选择',
    'news.selectFeaturedImage': '选择特色图片',
    'news.insertImages': '插入图片',
    'news.editMode': '编辑',
    'news.preview': '预览',
    'news.seo': 'SEO 设置',
    'news.seo.metaTitle': 'Meta 标题',
    'news.seo.metaDescription': 'Meta 描述',
    'news.seo.metaKeywords': 'Meta 关键词',
    'news.seo.titlePlaceholder': 'SEO 标题（建议 50-60 个字符）',
    'news.seo.descriptionPlaceholder': 'SEO 描述（建议 150-160 个字符）',
    'news.seo.keywordsPlaceholder': '关键词1, 关键词2, 关键词3',
    'news.seo.googlePreview': 'Google 搜索预览',
    'news.seo.articleTitle': '文章标题',
    'news.seo.articleDescription': '文章描述将显示在这里...',
    'news.seo.titleLength': '标题长度（建议 50-60）',
    'news.seo.descriptionLength': '描述长度（建议 150-160）',
    'news.seo.characters': '{count} 个字符',
    'news.publish': '发布设置',
    'news.publishedAt': '发布时间：{date}',
    'news.views': '浏览量：{count}',

    'sitePages.title': '站点页面',
    'sitePages.subtitle': '编辑网站页脚中链接的政策与说明页面。',
    'sitePages.saved': '页面保存成功',
    'sitePages.saveFailed': '保存页面失败',
    'sitePages.pageTitle': '页面标题',
    'sitePages.metaTitle': 'Meta 标题',
    'sitePages.summary': '摘要',
    'sitePages.metaDescription': 'Meta 描述',
    'sitePages.metaKeywords': 'Meta 关键词',
    'sitePages.content': '页面内容（Markdown）',
    'sitePages.markdownHint': '使用 ## 编写章节标题，使用 - 编写列表，链接格式为 [文字](URL)，YouTube/Vimeo 链接请单独放一行。',
    'sitePages.published': '已发布',
    'sitePages.viewPage': '查看页面',
    'sitePages.savePage': '保存页面',
    'sitePages.page.privacy': '隐私政策',
    'sitePages.page.terms': '服务条款',
    'sitePages.page.warranty': '质保说明',
    'sitePages.page.warranty-policy': '质保政策',
    'sitePages.page.shipping-policy': '配送政策',
    'sitePages.page.returns': '退货政策',
    'sitePages.page.technical-support': '技术支持',
