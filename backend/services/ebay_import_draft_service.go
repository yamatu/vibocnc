...
func BuildProductRequestFromDraft(db *gorm.DB, draft models.EbayImportDraft) models.ProductCreateRequest {
	...
	return models.ProductCreateRequest{
		...
		// Warranty and lead time follow the admin-editable commerce policy.
		WarrantyPeriod:  CommercePolicyWarrantyText(CurrentCommercePolicy()),
		LeadTime:        CommercePolicyLeadTimeText(CurrentCommercePolicy()),
