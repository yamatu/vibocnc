...
type EbayImportJSONTaskItem struct {
	...
	TaskID      string    `json:"task_id" gorm:"size:36;not null;uniqueIndex:idx_ebay_import_json_task_items_key,priority:1;index"`
	Fingerprint string    `json:"-" gorm:"size:64;not null;uniqueIndex:idx_ebay_import_json_task_items_key,priority:2;index"`
